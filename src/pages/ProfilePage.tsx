            ...
            <Card className="border-primary/30 cursor-pointer hover:shadow-md transition-shadow" onClick={() => onNavigate?.('pro')}>
              <CardContent className="p-4 flex items-center gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-muted-foreground">Erkinlik Strategiyasi, byudjet nazorati va boshqalar</p>
                </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-muted-foreground">
                    {user?.username ? `@${user.username} — Ulangan ✅` : (user?.firstName ? `${user.firstName} — Ulangan ✅` : 'Ulanmagan')}
                  </p>
                </div>
        ...
        <motion.div variants={item}>
          <Card>
            <CardContent className="p-4 divide-y divide-border">
              ...
              <SettingRow icon={Trash2} label="Ma'lumotlarni tozalash" onClick={() => toast.info("Bu funksiya tez kunda!")} action={<ChevronRight size={16} className="text-destructive" />} />
            </CardContent>
          </Card>
        </motion.div>
